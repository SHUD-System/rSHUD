...
#'
#' Legacy compatibility wrapper for \code{\link{plot_timeseries}}.
#'
#' @param x Time-series object to plot.
#' @param ... Additional arguments passed to \code{\link{plot_timeseries}}.
#' @return A plot object from \code{\link{plot_timeseries}}.
#' @export
plot_tsd <- function(x, ...) {
